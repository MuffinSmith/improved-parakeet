# Create a python function that searches for files in your ~/Download directory for any that contains the string `Stu_`
# Copy those files into the current directory
...
def stu_activities():
    ...
    for i in os.listdir(download_directory):
        ...
        # if the file path/name contains the string "stu_" - which is the indicator for a student activity
